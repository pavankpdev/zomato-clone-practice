  ...
  return (
    <>
      <div className=" hidden md:flex items-center my-6  ">
        <div className=" hidden md:flex items-center my-6  border-b-2 border-brand  w-max	mr-2 pb-2">
          <div className="h-12 bg-brandLite p-3 rounded-full">
            <img
          ...
          <h3 className="ml-3 text-xl text-brand font-semibold">Delivery</h3>
        </div>
        <div className=" hidden md:flex items-center my-6  border-b-2 border-brand  w-max	 pb-2">
          <div className="h-12 bg-brandLite p-3 rounded-full">
            <img
              src="https://b.zmtcdn.com/data/o2_assets/c0bb85d3a6347b2ec070a8db694588261616149578.png?output-format=webp"
              alt="delivery icon"
      ...
      <h1 className=" text-2xl md:text-3xl font-semibold text-gray-700 my-5 mb-10">
